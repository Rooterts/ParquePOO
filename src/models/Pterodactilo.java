...
public class Pterodactilo extends Animal{

    public Pterodactilo(int posColumna, int posFila, char simbolo,int contCodigo) {
        super(posColumna, posFila, simbolo);
        this.setCodigo("P"+String.valueOf(contCodigo));
        this.setEdadMaxima(10);//Establecer edad maxima pues son los mas longevos
