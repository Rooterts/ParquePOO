...
public class T_Rex extends Animal{

    public T_Rex(int posColumna, int posFila, char simbolo,int contCodigo) {
        super(posColumna, posFila, simbolo);
        this.setCodigo("R"+String.valueOf(contCodigo));
        this.setEdadMaxima(15);//Establecer edad maxima pues son los mas longevos
